...
export const SECTIONS = Object.freeze([
  ...
  { key: 'entry', href: '/entry', label: 'Reach', group: 'Now',
    question: 'What Fiverr showed, from the impressions board',
    icon: '<path d="M2.5 12.5 6 8l3 3 5.5-6.5"/><path d="M2.5 15.5h13"/>' },
  ...
  { key: 'pulse', href: '/pulse', label: 'Pulse', group: 'The work',
    question: 'What was delivered, by whom, and what the buyer said',
    icon: '<path d="M1.5 9h3l2-4.5L9 13l2.5-6 1.5 2h3.5"/>' },
