# XStudioz — What Next · Wednesday 26 August 2026

**Organic health: 🔴 BREACH** · index 27/100

**Why the constraint is breached**
- rolling: 7d MA -57.7% vs 14d ago (3.71 -> 1.57/day)
...
| :-- | --: | :-- | --: | :-- |
| jordyspikker | 165d | revision | $100 | Ahmed Ashfaq |
| calumsnell | 163d | revision | $100 | Nime |
| elite9921 | 117d | in_progress | $105 | Musharaf |
| institutoibt | 90d | revision | $115 | Nimeazad |
| moni_rotanak | 90d | revision | $115 | Abiha Imran |
| institutoibt | 62d | revision | $120 | Nimeazad |
| hoppycampers | 51d | revision | $150 | Amin |
| thisguy07 | 26d | revision | $250 | Amin |

**Quotes with no follow-up ever logged** — 4 worth $675

| Client | Quoted | Age | CSR |
| :-- | --: | --: | :-- |
| kutaibahussain | $380 | 6d | Hasnain |
| akhilkpfxx | $160 | 174d | Amrah |
| zain_qw | $75 | 56d | Swaid |
| Mohamed L | $60 | 107d | — |
...
*Why:* 6 orders worth $655 have been open longer than 60 days, out of 22 open orders worth $3,490 in total. The oldest is jordyspikker at 165 days. Every one of these buyers has already paid or committed, so this is not new business to win — it is delivered-or-owed work nobody closed. It is also the largest single block of recoverable money in the dataset, and unlike the funnel it needs no new traffic.
...
- Where we owe work — assign it to the designer named on the row with a delivery date this week. Oldest first: jordyspikker (165d, $100), calumsnell (163d, $100), elite9921 (117d, $105).
...
- Source rows: `jordyspikker: 165d, $100, revision`, `calumsnell: 163d, $100, revision`, `elite9921: 117d, $105, in_progress`, `institutoibt: 90d, $115, revision`, `moni_rotanak: 90d, $115, revision`, `institutoibt: 62d, $120, revision`

### P0 · Organic decline is a gig page and handling problem — act accordingly
**Owner:** CEO · **Est. impact:** $15,735 · **Effort:** 2.0h · **Confidence:** 75%

*Why:* Orders moved -97.0% over 14 days (165 -> 5). 89% of that swing is closing rate, which fell: impressions 116,279 -> 88,836, CTR 1.61% -> 1.86%, close rate 8.8% -> 0.3%. That makes this a gig page and handling problem — work on gig copy, packages, response speed, CSR quality.
...
### P0 · Fill revenue in the daily ledger (218 days blank)
**Owner:** Whoever owns the daily ledger · **Est. impact:** $2,000 · **Effort:** 2.0h · **Confidence:** 90%

*Why:* 218 ledger days record orders but $0 revenue. Every revenue forecast, the AOV target and the whole revenue side of the objective are currently inferred from the CRM sheet instead of measured, because this column is empty.
...
**Owner:** Ezan · **Est. impact:** $152 · **Effort:** 1.5h · **Confidence:** 45%

*Why:* 4 buyers were quoted $675 between them and no follow-up was ever logged against any of them — the largest is kutaibahussain at $380, quoted 6 days ago. That sits inside a total unanswered pipeline of $6,680 across 21 leads. Of the 31 quoted leads anyone did chase, 14 placed (45%); this is costed at half that, because these are older. Note the raw split is misleading: quoted leads with no follow-up appear to convert at 96%, but that is because a follow-up only gets logged when the buyer did not say yes immediately. These 4 are the residue of that group, not part of its success.

- Work the never-followed-up list first, largest first: kutaibahussain ($380, 6d), akhilkpfxx ($160, 174d), zain_qw ($75, 56d), Mohamed L ($60, 107d).
...
- Source rows: `kutaibahussain: $380, 6d, 0 follow-ups`, `akhilkpfxx: $160, 174d, 0 follow-ups`, `zain_qw: $75, 56d, 0 follow-ups`, `Mohamed L: $60, 107d, 0 follow-ups`, `bobzinos: $900, 161d, 1 follow-ups`, `farida_ism: $700, 194d, 1 follow-ups`, `tatiana_1017: $510, 21d, 1 follow-ups`, `ryan_wonders: $350, 120d, 1 follow-ups`, `rztwerk: $250, 30d, 1 follow-ups`, `chupetes: $200, 169d, 1 follow-ups`
...
*Why:* Upsell is marked on 0.0% of the 190 orders whose tab has an Upsell column. That is not a low upsell rate, it is an unused column. The highest-value lever in the funnel currently cannot be measured, which means it cannot be improved or defended.
...
|---|---|---|---|
| 2026-09-02 | Organic orders over the 7 days to 02 Sep will be 11.0 (80% CI 6.8-15.3). | 6.78 – 15.28 | medium |
| 2026-09-09 | Organic health index in 14 days will be 35 (80% CI 22-45). | 22.36 – 44.75 | low |
| 2026-09-02 | Total orders/day averaged over the next 7 days will be 3.61 (80% CI 2.69-4.53). | 2.69 – 4.53 | medium |
| 2026-09-25 | Blended AOV in 30 days will be $98 (80% CI $82-$125). | 82.42 – 124.67 | high |
| 2026-09-02 | Inquiry->order conversion in 7 days will be 21.4% (80% CI 17.5%-24.4%). | 0.18 – 0.24 | high |

### Resolved since last run

| Made on | Prediction | Predicted | Actual | In interval? |
|---|---|---|---|---|
| 2026-08-12 | health.index | 83.30 | 27.40 | ❌ |
| 2026-08-19 | flow_7d.organic | 15.68 | 11.00 | ✅ |
| 2026-08-19 | flow_7d.total_per_day | 5.01 | 3.57 | ❌ |
| 2026-08-19 | funnel.conversion | 0.22 | 0.21 | ✅ |

**Track record:** 128 resolved, coverage 49% 
...
| Metric | Value | Note |
|---|---|---|
| Organic orders/day (7d MA) | 1.57 | vs 3.71 14d ago |
| Organic, recent vs earlier | 1.43/day | was 0.66/day (+118.2%) |
| Organic orders, 7d to 25 Aug | 11 | 1.57/day |
| AOV | $98 | median $80, n=162 priced orders |
| Lifetime tracked revenue | $15,932 | across 190 order rows |
| Inquiry conversion | 21.4% | 25/117 |
| Upsell recorded | 0.0% | column is effectively unused |
| Review capture | 48.4% | 92/190 orders that could be rated |
| Gig rating | 4.841 | 1,637 reviews, Level 2 |
| Orders in queue | 22 | live from the gig page |

### Revenue path

At 1.57 orders/day and $98 AOV, the next 30 days project **$4,636** (47 orders).
...
|---|---|---|---|
| Shift: Night | 34 | 32.4% | 19.1% |
| Shift: Evening | 41 | 22.0% | 12.0% |
| Shift: Morning | 38 | 13.2% | 5.8% |
| United Kingdom | 36 | 36.1% | 22.5% |
...
| Order and inquiry workbooks | 🟢 live | 2026-08-26T02:14:36.952000+00:00 | 0h | Apps Script snapshot endpoint |
| Impressions source | 🟢 live | 2026-08-24 | 0h | impressions board, via IMPRESSIONS_SUPABASE_KEY |
| Impressions (engine copy) | 🟢 live | 2026-08-24 | 38h | board, merged over the Daily Data Sheet |
| Fiverr gig page | 🟠 stale | 2026-08-16 | 230h | browser capture into data/raw/gig/ |
| CSR handoff tracker | 🟠 stale | 2026-08-08 | 426h | uploaded into data/raw/order_tracker/ |
...
*Generated 2026-08-26 by the XStudioz growth engine. Read-only: no source sheet was modified.*