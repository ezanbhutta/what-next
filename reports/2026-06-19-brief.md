# XStudioz — What Next · Friday 19 June 2026
...
- rolling: 7d MA -28.6% vs 14d ago (1.00 -> 0.71/day)
...
*Why:* Organic constraint breached — rolling: 7d MA -28.6% vs 14d ago (1.00 -> 0.71/day). The objective makes organic recovery a hard constraint, so the dose is cut by 2/day and revenue upside is ignored until flow recovers. Quota 0/week (0.00/day); share cap allows 0.58/day.
...
### P3 · Revive stalled order #7 — institutoibt (18d silent)
**Owner:** Assigned CSR · **Est. impact:** $51 · **Effort:** 0.25h · **Confidence:** 45%

*Why:* Status 'Rev Sent' with no update for 18 days. In this dataset, orders that go quiet after a revision are the ones that end up Dead — and a Dead order still occupies a delivery slot and produces no review.
...
Per ISO week: **2026-W25** = 0, **2026-W26** = 0 (quota is 0/week; a 7-day window straddles two weeks, so these will not both equal the quota).
...
|---|---|---|---|
| 2026-06-26 | Organic orders over the 7 days to 26 Jun will be 5.6 (80% CI 2.6-8.6). | 2.57 – 8.63 | medium |
| 2026-07-03 | Organic health index in 14 days will be 46 (80% CI 42-66). | 42.16 – 65.95 | low |
| 2026-06-26 | Total orders/day averaged over the next 7 days will be 3.21 (80% CI 2.34-4.07). | 2.34 – 4.07 | medium |
| 2026-07-19 | Blended AOV in 30 days will be $128 (80% CI $113-$144). | 112.98 – 143.80 | high |
| 2026-06-26 | Inquiry->order conversion in 7 days will be 33.5% (80% CI 28.4%-38.5%). | 0.28 – 0.38 | high |

### Resolved since last run

| Made on | Prediction | Predicted | Actual | In interval? |
|---|---|---|---|---|
| 2026-06-03 | health.index | 51.10 | 34.50 | ❌ |
| 2026-06-11 | flow_7d.organic | 5.60 | 5.00 | ✅ |
| 2026-06-11 | flow_7d.total_per_day | 3.21 | 0.71 | ❌ |
| 2026-06-11 | funnel.conversion | 0.33 | 0.33 | ✅ |

**Track record:** 10 resolved, coverage 50% 
(target 80%), median absolute error 31%.
...
| Metric | Value | Note |
|---|---|---|
| Organic orders/day (7d MA) | 0.71 | vs 1.00 14d ago |
| Total orders/day (7d) | 0.71 | 5 organic + 0 VVRO |
...
*Generated 2026-06-19 by the XStudioz growth engine. Read-only: no source sheet was modified.*