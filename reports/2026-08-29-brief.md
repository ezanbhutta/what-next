# XStudioz — What Next · Saturday 29 August 2026

**Organic health: 🔴 BREACH** · index 31/100

**Why the constraint is breached**
- rolling: 7d MA -54.5% vs 14d ago (3.14 -> 1.43/day)
...
| :-- | --: | :-- | --: | :-- |
| jordyspikker | 168d | revision | $100 | Ahmed Ashfaq |
| calumsnell | 166d | revision | $100 | Nime |
| elite9921 | 120d | in_progress | $105 | Musharaf |
| institutoibt | 93d | revision | $115 | Nimeazad |
| moni_rotanak | 93d | revision | $115 | Abiha Imran |
| institutoibt | 65d | revision | $120 | Nimeazad |
| hoppycampers | 54d | revision | $150 | Amin |
| thisguy07 | 29d | revision | $250 | Amin |

**Quotes with no follow-up ever logged** — 3 worth $295

| Client | Quoted | Age | CSR |
| :-- | --: | --: | :-- |
| akhilkpfxx | $160 | 177d | Amrah |
| zain_qw | $75 | 59d | Swaid |
| Mohamed L | $60 | 110d | — |
...
*Why:* 6 orders worth $655 have been open longer than 60 days, out of 22 open orders worth $3,590 in total. The oldest is jordyspikker at 168 days. Every one of these buyers has already paid or committed, so this is not new business to win — it is delivered-or-owed work nobody closed. It is also the largest single block of recoverable money in the dataset, and unlike the funnel it needs no new traffic.
...
- Where we owe work — assign it to the designer named on the row with a delivery date this week. Oldest first: jordyspikker (168d, $100), calumsnell (166d, $100), elite9921 (120d, $105).
...
- Source rows: `jordyspikker: 168d, $100, revision`, `calumsnell: 166d, $100, revision`, `elite9921: 120d, $105, in_progress`, `institutoibt: 93d, $115, revision`, `moni_rotanak: 93d, $115, revision`, `institutoibt: 65d, $120, revision`

### P0 · Organic decline is a gig page and handling problem — act accordingly
**Owner:** CEO · **Est. impact:** $15,395 · **Effort:** 2.0h · **Confidence:** 75%

*Why:* Orders moved -96.9% over 14 days (161 -> 5). 88% of that swing is closing rate, which fell: impressions 118,470 -> 87,772, CTR 1.62% -> 1.88%, close rate 8.4% -> 0.3%. That makes this a gig page and handling problem — work on gig copy, packages, response speed, CSR quality.
...
### P0 · Fill revenue in the daily ledger (231 days blank)
**Owner:** Whoever owns the daily ledger · **Est. impact:** $2,000 · **Effort:** 2.0h · **Confidence:** 90%

*Why:* 231 ledger days record orders but $0 revenue. Every revenue forecast, the AOV target and the whole revenue side of the objective are currently inferred from the CRM sheet instead of measured, because this column is empty.
...
*Why:* 3 buyers were quoted $295 between them and no follow-up was ever logged against any of them — the largest is akhilkpfxx at $160, quoted 177 days ago. That sits inside a total unanswered pipeline of $6,170 across 20 leads. Of the 33 quoted leads anyone did chase, 16 placed (48%); this is costed at half that, because these are older. Note the raw split is misleading: quoted leads with no follow-up appear to convert at 97%, but that is because a follow-up only gets logged when the buyer did not say yes immediately. These 3 are the residue of that group, not part of its success.

- Work the never-followed-up list first, largest first: akhilkpfxx ($160, 177d), zain_qw ($75, 59d), Mohamed L ($60, 110d).
...
- Source rows: `akhilkpfxx: $160, 177d, 0 follow-ups`, `zain_qw: $75, 59d, 0 follow-ups`, `Mohamed L: $60, 110d, 0 follow-ups`, `bobzinos: $900, 164d, 1 follow-ups`, `farida_ism: $700, 197d, 1 follow-ups`, `ryan_wonders: $350, 123d, 1 follow-ups`, `rztwerk: $250, 33d, 1 follow-ups`, `chupetes: $200, 172d, 1 follow-ups`, `dgtl_depot: $175, 205d, 1 follow-ups`, `paulmesaric: $175, 204d, 1 follow-ups`
...
*Why:* Upsell is marked on 0.0% of the 202 orders whose tab has an Upsell column. That is not a low upsell rate, it is an unused column. The highest-value lever in the funnel currently cannot be measured, which means it cannot be improved or defended.
...
|---|---|---|---|
| 2026-09-05 | Organic orders over the 7 days to 05 Sep will be 12.4 (80% CI 7.9-17.0). | 7.93 – 16.96 | medium |
| 2026-09-12 | Organic health index in 14 days will be 39 (80% CI 25-51). | 24.70 – 50.55 | low |
| 2026-09-05 | Total orders/day averaged over the next 7 days will be 3.66 (80% CI 2.74-4.59). | 2.74 – 4.59 | medium |
| 2026-09-28 | Blended AOV in 30 days will be $99 (80% CI $84-$124). | 83.52 – 124.25 | high |
| 2026-09-05 | Inquiry->order conversion in 7 days will be 21.6% (80% CI 17.8%-24.6%). | 0.18 – 0.25 | high |

### Resolved since last run

| Made on | Prediction | Predicted | Actual | In interval? |
|---|---|---|---|---|
| 2026-08-22 | flow_7d.organic | 15.00 | 10.00 | ❌ |
| 2026-08-22 | flow_7d.total_per_day | 4.82 | 3.14 | ❌ |
| 2026-08-22 | funnel.conversion | 0.21 | 0.22 | ✅ |

**Track record:** 140 resolved, coverage 49% 
...
| Metric | Value | Note |
|---|---|---|
| Organic orders/day (7d MA) | 1.43 | vs 3.14 14d ago |
| Organic, recent vs earlier | 1.47/day | was 0.66/day (+123.7%) |
| Organic orders, 7d to 28 Aug | 10 | 1.43/day |
| AOV | $99 | median $80, n=170 priced orders |
| Lifetime tracked revenue | $16,777 | across 202 order rows |
| Inquiry conversion | 21.6% | 27/125 |
| Upsell recorded | 0.0% | column is effectively unused |
| Review capture | 47.5% | 96/202 orders that could be rated |
| Gig rating | 4.841 | 1,637 reviews, Level 2 |
| Orders in queue | 22 | live from the gig page |

### Revenue path

At 1.43 orders/day and $99 AOV, the next 30 days project **$4,230** (43 orders).
...
| Order and inquiry workbooks | 🟢 live | 2026-08-29T02:14:24.884000+00:00 | 0h | Apps Script snapshot endpoint |
| Impressions source | 🟢 live | 2026-08-27 | 0h | impressions board, via IMPRESSIONS_SUPABASE_KEY |
| Impressions (engine copy) | 🟢 live | 2026-08-27 | 38h | board, merged over the Daily Data Sheet |
| Fiverr gig page | 🟠 stale | 2026-08-16 | 302h | browser capture into data/raw/gig/ |
| CSR handoff tracker | 🟠 stale | 2026-08-08 | 498h | uploaded into data/raw/order_tracker/ |
...
*Generated 2026-08-29 by the XStudioz growth engine. Read-only: no source sheet was modified.*