# XStudioz — What Next · Friday 28 August 2026

**Organic health: 🔴 BREACH** · index 32/100

**Why the constraint is breached**
- rolling: 7d MA -56.5% vs 14d ago (3.29 -> 1.43/day)

## Money sitting still

**$6,825** is committed or quoted and not moving — $655 in orders open more than 60 days, $6,170 in quotes that were never placed.
...
| :-- | --: | :-- | --: | :-- |
| jordyspikker | 167d | revision | $100 | Ahmed Ashfaq |
| calumsnell | 165d | revision | $100 | Nime |
| elite9921 | 119d | in_progress | $105 | Musharaf |
| institutoibt | 92d | revision | $115 | Nimeazad |
| moni_rotanak | 92d | revision | $115 | Abiha Imran |
| institutoibt | 64d | revision | $120 | Nimeazad |
| hoppycampers | 53d | revision | $150 | Amin |
| thisguy07 | 28d | revision | $250 | Amin |

**Quotes with no follow-up ever logged** — 3 worth $295

| Client | Quoted | Age | CSR |
| :-- | --: | --: | :-- |
| akhilkpfxx | $160 | 176d | Amrah |
| zain_qw | $75 | 58d | Swaid |
| Mohamed L | $60 | 109d | — |
...
*Why:* 6 orders worth $655 have been open longer than 60 days, out of 21 open orders worth $3,460 in total. The oldest is jordyspikker at 167 days. Every one of these buyers has already paid or committed, so this is not new business to win — it is delivered-or-owed work nobody closed. It is also the largest single block of recoverable money in the dataset, and unlike the funnel it needs no new traffic.
...
- Where we owe work — assign it to the designer named on the row with a delivery date this week. Oldest first: jordyspikker (167d, $100), calumsnell (165d, $100), elite9921 (119d, $105).
...
- Source rows: `jordyspikker: 167d, $100, revision`, `calumsnell: 165d, $100, revision`, `elite9921: 119d, $105, in_progress`, `institutoibt: 92d, $115, revision`, `moni_rotanak: 92d, $115, revision`, `institutoibt: 64d, $120, revision`

### P0 · Organic decline is a gig page and handling problem — act accordingly
**Owner:** CEO · **Est. impact:** $15,172 · **Effort:** 2.0h · **Confidence:** 75%

*Why:* Orders moved -96.3% over 14 days (161 -> 6). 88% of that swing is closing rate, which fell: impressions 117,815 -> 89,451, CTR 1.61% -> 1.89%, close rate 8.5% -> 0.4%. That makes this a gig page and handling problem — work on gig copy, packages, response speed, CSR quality.
...
### P0 · Fill revenue in the daily ledger (226 days blank)
**Owner:** Whoever owns the daily ledger · **Est. impact:** $2,000 · **Effort:** 2.0h · **Confidence:** 90%

*Why:* 226 ledger days record orders but $0 revenue. Every revenue forecast, the AOV target and the whole revenue side of the objective are currently inferred from the CRM sheet instead of measured, because this column is empty.
...
*Why:* 3 buyers were quoted $295 between them and no follow-up was ever logged against any of them — the largest is akhilkpfxx at $160, quoted 176 days ago. That sits inside a total unanswered pipeline of $6,170 across 20 leads. Of the 33 quoted leads anyone did chase, 16 placed (48%); this is costed at half that, because these are older. Note the raw split is misleading: quoted leads with no follow-up appear to convert at 97%, but that is because a follow-up only gets logged when the buyer did not say yes immediately. These 3 are the residue of that group, not part of its success.

- Work the never-followed-up list first, largest first: akhilkpfxx ($160, 176d), zain_qw ($75, 58d), Mohamed L ($60, 109d).
...
- Source rows: `akhilkpfxx: $160, 176d, 0 follow-ups`, `zain_qw: $75, 58d, 0 follow-ups`, `Mohamed L: $60, 109d, 0 follow-ups`, `bobzinos: $900, 163d, 1 follow-ups`, `farida_ism: $700, 196d, 1 follow-ups`, `ryan_wonders: $350, 122d, 1 follow-ups`, `rztwerk: $250, 32d, 1 follow-ups`, `chupetes: $200, 171d, 1 follow-ups`, `dgtl_depot: $175, 204d, 1 follow-ups`, `paulmesaric: $175, 203d, 1 follow-ups`
...
*Why:* Upsell is marked on 0.0% of the 197 orders whose tab has an Upsell column. That is not a low upsell rate, it is an unused column. The highest-value lever in the funnel currently cannot be measured, which means it cannot be improved or defended.
...
|---|---|---|---|
| 2026-09-04 | Organic orders over the 7 days to 04 Sep will be 11.2 (80% CI 6.9-15.5). | 6.93 – 15.50 | medium |
| 2026-09-11 | Organic health index in 14 days will be 40 (80% CI 26-53). | 25.91 – 53.04 | low |
| 2026-09-04 | Total orders/day averaged over the next 7 days will be 3.61 (80% CI 2.69-4.53). | 2.69 – 4.53 | medium |
| 2026-09-27 | Blended AOV in 30 days will be $98 (80% CI $83-$123). | 82.84 – 123.23 | high |
| 2026-09-04 | Inquiry->order conversion in 7 days will be 21.8% (80% CI 17.9%-24.8%). | 0.18 – 0.25 | high |

### Resolved since last run

| Made on | Prediction | Predicted | Actual | In interval? |
|---|---|---|---|---|
| 2026-07-29 | economics.aov | 108.98 | 97.88 | ✅ |
| 2026-08-14 | health.index | 83.30 | 32.50 | ❌ |
| 2026-08-21 | flow_7d.organic | 14.86 | 10.00 | ✅ |
| 2026-08-21 | flow_7d.total_per_day | 5.14 | 3.00 | ❌ |
| 2026-08-21 | funnel.conversion | 0.21 | 0.22 | ✅ |

**Track record:** 137 resolved, coverage 49% 
...
| Metric | Value | Note |
|---|---|---|
| Organic orders/day (7d MA) | 1.43 | vs 3.29 14d ago |
| Organic, recent vs earlier | 1.43/day | was 0.66/day (+118.6%) |
| Organic orders, 7d to 27 Aug | 10 | 1.43/day |
| AOV | $98 | median $80, n=169 priced orders |
| Lifetime tracked revenue | $16,542 | across 197 order rows |
| Inquiry conversion | 21.8% | 27/124 |
| Upsell recorded | 0.0% | column is effectively unused |
| Review capture | 48.7% | 96/197 orders that could be rated |
| Gig rating | 4.841 | 1,637 reviews, Level 2 |
| Orders in queue | 22 | live from the gig page |

### Revenue path

At 1.43 orders/day and $98 AOV, the next 30 days project **$4,195** (43 orders).
...
| Order and inquiry workbooks | 🟢 live | 2026-08-28T02:14:21.358000+00:00 | 0h | Apps Script snapshot endpoint |
| Impressions source | 🟢 live | 2026-08-26 | 0h | impressions board, via IMPRESSIONS_SUPABASE_KEY |
| Impressions (engine copy) | 🟢 live | 2026-08-26 | 38h | board, merged over the Daily Data Sheet |
| Fiverr gig page | 🟠 stale | 2026-08-16 | 278h | browser capture into data/raw/gig/ |
| CSR handoff tracker | 🟠 stale | 2026-08-08 | 474h | uploaded into data/raw/order_tracker/ |
...
*Generated 2026-08-28 by the XStudioz growth engine. Read-only: no source sheet was modified.*