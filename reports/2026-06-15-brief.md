# XStudioz — What Next · Monday 15 June 2026

**Organic health: 🔴 BREACH** · index 55/100 · VVRO share 0% (cap 45%)

> Place **0 VVRO orders today** — quota is **0/week**, and today is a rest day (organic_health_breach).

**Why the constraint is breached**
- rolling: 7d MA -20.0% vs 14d ago (1.00 -> 0.80/day)
...
*Why:* Organic constraint breached — rolling: 7d MA -20.0% vs 14d ago (1.00 -> 0.80/day). The objective makes organic recovery a hard constraint, so the dose is cut by 2/day and revenue upside is ignored until flow recovers. Quota 0/week (0.00/day); share cap allows 0.65/day.

- Place **0 VVRO orders today** — quota is **0/week**, and today is a rest day (organic_health_breach).
- No placements today.
- At this quota the VVRO share settles at 0%, against a cap of 0.65 VVRO/day at the current organic rate.
...
### P3 · Revive stalled order #7 — institutoibt (14d silent)
**Owner:** Assigned CSR · **Est. impact:** $51 · **Effort:** 0.25h · **Confidence:** 45%

*Why:* Status 'Rev Sent' with no update for 14 days. In this dataset, orders that go quiet after a revision are the ones that end up Dead — and a Dead order still occupies a delivery slot and produces no review.
...
- **Ceiling from share cap:** 0.65/day at the current organic rate of 0.80/day
- **Projected VVRO share at this rate:** 0%
- **Cooldown until:** 2026-06-18
...
Per ISO week: **2026-W25** = 0 (quota is 0/week; a 7-day window straddles two weeks, so these will not both equal the quota).
...
|---|---|---|---|
| 2026-06-22 | Organic orders over the 7 days to 22 Jun will be 5.6 (80% CI 2.6-8.6). | 2.57 – 8.63 | medium |
| 2026-06-29 | Organic health index in 14 days will be 67 (80% CI 52-81). | 52.03 – 81.37 | low |
| 2026-06-22 | Total orders/day averaged over the next 7 days will be 3.21 (80% CI 2.34-4.07). | 2.34 – 4.07 | medium |
| 2026-07-15 | Blended AOV in 30 days will be $128 (80% CI $113-$144). | 112.98 – 143.80 | high |
| 2026-06-22 | Inquiry->order conversion in 7 days will be 33.5% (80% CI 28.4%-38.5%). | 0.28 – 0.38 | high |

### Resolved since last run

| Made on | Prediction | Predicted | Actual | In interval? |
|---|---|---|---|---|
| 2026-06-07 | flow_7d.organic | 5.60 | 4.00 | ✅ |
| 2026-06-07 | flow_7d.total_per_day | 3.21 | 0.57 | ❌ |
| 2026-06-07 | funnel.conversion | 0.33 | 0.33 | ✅ |

**Track record:** 6 resolved, coverage 50% 
(target 80%), median absolute error 55%.
...
| Metric | Value | Note |
|---|---|---|
| Organic orders/day (7d MA) | 0.80 | vs 1.00 14d ago |
| Total orders/day (7d) | 0.57 | 4 organic + 0 VVRO |
...
At 0.80 orders/day and $128 AOV, the next 30 days project **$3,081** (24 orders).

That is **$5,419 behind** the 30-day target. Two routes close it:

- **Volume:** +42 orders (+1.41/day). **Not feasible** — the organic constraint caps volume, and VVRO is already at its ceiling.
- **AOV:** raise AOV to $354 (+176%). This is the route the constraint leaves open.
...
*Generated 2026-06-15 by the XStudioz growth engine. Read-only: no source sheet was modified.*