# XStudioz — What Next · Thursday 06 August 2026
...
| :-- | --: | :-- | --: | :-- |
| osmanbey_35 | 273d | in_progress | $250 | Aashir |
| faisalkazmi53 | 189d | in_progress | $0 | Shaoor |
| andrem530 | 164d | revision | $295 | Amin |
| jordyspikker | 145d | revision | $100 | Ahmed Ashfaq |
| calumsnell | 143d | revision | $100 | Nime |
| kuykendalljr | 140d | in_progress | $75 | Saad Sajid |
| vickizhou318 | 131d | in_progress | $0 | — |
| paolowhite | 103d | delivered | $320 | Zahid |
...
| :-- | --: | --: | :-- |
| akhilkpfxx | $160 | 154d | — |
| architpatel497 | $147 | 42d | Iqra |
| kai_utzinger | $85 | 101d | — |
| zain_qw | $75 | 36d | Swaid |
| Mohamed L | $60 | 87d | — |
...
*Why:* Buyer has raised refund/dispute language and the order is rev sent. A single 1-star review would move the public rating by 0.0024 (4.839 -> 4.837) across 1,606 reviews, and that rating is what every future buyer sorts on. The order is worth ~$92; the rating damage is worth far more.
...
- Where we owe work — assign it to the designer named on the row with a delivery date this week. Oldest first: osmanbey_35 (273d, $250), andrem530 (164d, $295), jordyspikker (145d, $100).
...
- Source rows: `osmanbey_35: 273d, $250, in_progress`, `faisalkazmi53: 189d, $0, in_progress`, `andrem530: 164d, $295, revision`, `jordyspikker: 145d, $100, revision`, `calumsnell: 143d, $100, revision`, `kuykendalljr: 140d, $75, in_progress`, `vickizhou318: 131d, $0, in_progress`, `paolowhite: 103d, $320, delivered`, `alialbalawi896: 98d, $115, revision`, `elite9921: 97d, $105, in_progress`
...
*Why:* 5 buyers were quoted $527 between them and no follow-up was ever logged against any of them — the largest is akhilkpfxx at $160, quoted 154 days ago. That sits inside a total unanswered pipeline of $5,722 across 20 leads. Of the 24 quoted leads anyone did chase, 9 placed (38%); this is costed at half that, because these are older. Note the raw split is misleading: quoted leads with no follow-up appear to convert at 93%, but that is because a follow-up only gets logged when the buyer did not say yes immediately. These 5 are the residue of that group, not part of its success.

- Work the never-followed-up list first, largest first: akhilkpfxx ($160, 154d), architpatel497 ($147, 42d), kai_utzinger ($85, 101d), zain_qw ($75, 36d).
...
- Source rows: `akhilkpfxx: $160, 154d, 0 follow-ups`, `architpatel497: $147, 42d, 0 follow-ups`, `kai_utzinger: $85, 101d, 0 follow-ups`, `zain_qw: $75, 36d, 0 follow-ups`, `Mohamed L: $60, 87d, 0 follow-ups`, `bobzinos: $900, 141d, 1 follow-ups`, `farida_ism: $700, 174d, 1 follow-ups`, `ryan_wonders: $350, 100d, 1 follow-ups`, `rztwerk: $250, 10d, 1 follow-ups`, `chupetes: $200, 149d, 1 follow-ups`
...
|---|---|---|---|
| 2026-08-13 | Organic orders over the 7 days to 13 Aug will be 4.3 (80% CI 1.7-7.0). | 1.67 – 7.00 | medium |
| 2026-08-20 | Organic health index in 14 days will be 34 (80% CI 21-45). | 21.21 – 45.12 | low |
| 2026-08-13 | Total orders/day averaged over the next 7 days will be 3.63 (80% CI 2.71-4.55). | 2.71 – 4.55 | medium |
| 2026-09-05 | Blended AOV in 30 days will be $92 (80% CI $81-$107). | 80.86 – 106.60 | high |
| 2026-08-13 | Inquiry->order conversion in 7 days will be 17.7% (80% CI 15.2%-20.5%). | 0.15 – 0.20 | high |
...
| Organic orders, last 7d | 2 | 0.29/day |
...
*Generated 2026-08-06 by the XStudioz growth engine. Read-only: no source sheet was modified.*