# XStudioz — What Next · Sunday 30 August 2026

**Organic health: 🔴 BREACH** · index 28/100

**Why the constraint is breached**
- rolling: 7d MA -45.0% vs 14d ago (2.86 -> 1.57/day)
...
| :-- | --: | :-- | --: | :-- |
| jordyspikker | 169d | revision | $100 | Ahmed Ashfaq |
| calumsnell | 167d | revision | $100 | Nime |
| elite9921 | 121d | in_progress | $105 | Musharaf |
| moni_rotanak | 94d | revision | $115 | Abiha Imran |
| institutoibt | 66d | revision | $120 | Nimeazad |
| hoppycampers | 55d | revision | $150 | Amin |
| thisguy07 | 30d | revision | $250 | Amin |
| slimcharles128 | 25d | revision | $300 | Amin |
...
*Why:* 5 orders worth $540 have been open longer than 60 days, out of 22 open orders worth $3,710 in total. The oldest is jordyspikker at 169 days. Every one of these buyers has already paid or committed, so this is not new business to win — it is delivered-or-owed work nobody closed. It is also the largest single block of recoverable money in the dataset, and unlike the funnel it needs no new traffic.
...
- Where we owe work — assign it to the designer named on the row with a delivery date this week. Oldest first: jordyspikker (169d, $100), calumsnell (167d, $100), elite9921 (121d, $105).
...
- Source rows: `jordyspikker: 169d, $100, revision`, `calumsnell: 167d, $100, revision`, `elite9921: 121d, $105, in_progress`, `moni_rotanak: 94d, $115, revision`, `institutoibt: 66d, $120, revision`

### P0 · Organic decline is a gig page and handling problem — act accordingly
**Owner:** CEO · **Est. impact:** $14,688 · **Effort:** 2.0h · **Confidence:** 75%

*Why:* Orders moved -94.9% over 14 days (156 -> 8). 86% of that swing is closing rate, which fell: impressions 118,425 -> 87,966, CTR 1.62% -> 1.88%, close rate 8.1% -> 0.5%. That makes this a gig page and handling problem — work on gig copy, packages, response speed, CSR quality.
...
### P0 · Fill revenue in the daily ledger (235 days blank)
**Owner:** Whoever owns the daily ledger · **Est. impact:** $2,000 · **Effort:** 2.0h · **Confidence:** 90%

*Why:* 235 ledger days record orders but $0 revenue. Every revenue forecast, the AOV target and the whole revenue side of the objective are currently inferred from the CRM sheet instead of measured, because this column is empty.
...
*Why:* Upsell is marked on 0.0% of the 205 orders whose tab has an Upsell column. That is not a low upsell rate, it is an unused column. The highest-value lever in the funnel currently cannot be measured, which means it cannot be improved or defended.
...
|---|---|---|---|
| 2026-09-06 | Organic orders over the 7 days to 06 Sep will be 11.3 (80% CI 7.0-15.6). | 6.97 – 15.56 | medium |
| 2026-09-13 | Organic health index in 14 days will be 36 (80% CI 23-47). | 22.93 – 47.40 | low |
| 2026-09-06 | Total orders/day averaged over the next 7 days will be 3.43 (80% CI 2.54-4.33). | 2.54 – 4.33 | medium |
| 2026-09-29 | Blended AOV in 30 days will be $99 (80% CI $84-$125). | 83.99 – 124.94 | high |

### Resolved since last run

| Made on | Prediction | Predicted | Actual | In interval? |
|---|---|---|---|---|
| 2026-08-16 | health.index | 79.30 | 27.60 | ❌ |
| 2026-08-23 | flow_7d.organic | 11.94 | 11.00 | ✅ |
| 2026-08-23 | flow_7d.total_per_day | 4.19 | 3.29 | ✅ |
| 2026-08-23 | funnel.conversion | 0.21 | 0.00 | ❌ |

**Track record:** 144 resolved, coverage 49% 
...
| Metric | Value | Note |
|---|---|---|
| Organic orders/day (7d MA) | 1.57 | vs 2.86 14d ago |
| Organic, recent vs earlier | 1.46/day | was 0.66/day (+122.2%) |
| Organic orders, 7d to 29 Aug | 11 | 1.57/day |
| AOV | $99 | median $80, n=175 priced orders |
| Lifetime tracked revenue | $17,367 | across 205 order rows |
| Inquiry conversion | 0.0% | 0/0 |
| Upsell recorded | 0.0% | column is effectively unused |
| Review capture | 46.8% | 96/205 orders that could be rated |
| Gig rating | 4.841 | 1,637 reviews, Level 2 |
| Orders in queue | 22 | live from the gig page |

### Revenue path

At 1.57 orders/day and $99 AOV, the next 30 days project **$4,678** (47 orders).
...
| Order and inquiry workbooks | 🟢 live | 2026-08-30T02:14:21.892000+00:00 | 0h | Apps Script snapshot endpoint |
| Impressions source | 🟢 live | 2026-08-28 | 0h | impressions board, via IMPRESSIONS_SUPABASE_KEY |
| Impressions (engine copy) | 🟢 live | 2026-08-28 | 38h | board, merged over the Daily Data Sheet |
| Fiverr gig page | 🟠 stale | 2026-08-16 | 326h | browser capture into data/raw/gig/ |
| CSR handoff tracker | 🟠 stale | 2026-08-08 | 522h | uploaded into data/raw/order_tracker/ |
...
- dropped prediction '72f52ce5fd4c': degenerate interval
...
*Generated 2026-08-30 by the XStudioz growth engine. Read-only: no source sheet was modified.*