# XStudioz — What Next · Wednesday 02 September 2026

**Organic health: 🔴 BREACH** · index 20/100

**Why the constraint is breached**
- rolling: 7d MA -30.8% vs 14d ago (1.86 -> 1.29/day)

## Money sitting still

**$6,590** is committed or quoted and not moving — $420 in orders open more than 60 days, $6,170 in quotes that were never placed.
...
| :-- | --: | :-- | --: | :-- |
| jordyspikker | 172d | revision | $100 | Ahmed Ashfaq |
| calumsnell | 170d | revision | $100 | Nime |
| elite9921 | 124d | in_progress | $105 | Musharaf |
| moni_rotanak | 97d | revision | $115 | Abiha Imran |
| hoppycampers | 58d | revision | $150 | Amin |
| thisguy07 | 33d | revision | $250 | Amin |
| slimcharles128 | 28d | revision | $300 | Amin |
| akshayrajput_18 | 22d | revision | $175 | Ahmad Fawad |

**Quotes with no follow-up ever logged** — 3 worth $295

| Client | Quoted | Age | CSR |
| :-- | --: | --: | :-- |
| akhilkpfxx | $160 | 181d | Amrah |
| zain_qw | $75 | 63d | Swaid |
| Mohamed L | $60 | 114d | — |

## Do today

### P0 · Close out 4 orders open more than 60 days ($420)
**Owner:** Ezan · **Est. impact:** $168 · **Effort:** 3.0h · **Confidence:** 60%

*Why:* 4 orders worth $420 have been open longer than 60 days, out of 19 open orders worth $3,065 in total. The oldest is jordyspikker at 172 days. Every one of these buyers has already paid or committed, so this is not new business to win — it is delivered-or-owed work nobody closed. It is also the largest single block of recoverable money in the dataset, and unlike the funnel it needs no new traffic.
...
- Where we owe work — assign it to the designer named on the row with a delivery date this week. Oldest first: jordyspikker (172d, $100), calumsnell (170d, $100), elite9921 (124d, $105).
...
- Source rows: `jordyspikker: 172d, $100, revision`, `calumsnell: 170d, $100, revision`, `elite9921: 124d, $105, in_progress`, `moni_rotanak: 97d, $115, revision`

### P0 · Fill revenue in the daily ledger (245 days blank)
**Owner:** Whoever owns the daily ledger · **Est. impact:** $2,000 · **Effort:** 2.0h · **Confidence:** 90%

*Why:* 245 ledger days record orders but $0 revenue. Every revenue forecast, the AOV target and the whole revenue side of the objective are currently inferred from the CRM sheet instead of measured, because this column is empty.
...
**Owner:** CEO · **Est. impact:** $700 · **Effort:** 2.0h · **Confidence:** 75%

*Why:* Orders moved -41.2% over 14 days (17 -> 10). 75% of that swing is reach, which fell: impressions 110,867 -> 70,788, CTR 1.64% -> 1.70%, close rate 0.9% -> 0.8%. That makes this a ranking problem — work on review velocity, on-time delivery, response time.
...
*Why:* 3 buyers were quoted $295 between them and no follow-up was ever logged against any of them — the largest is akhilkpfxx at $160, quoted 181 days ago. That sits inside a total unanswered pipeline of $6,170 across 20 leads. Of the 33 quoted leads anyone did chase, 16 placed (48%); this is costed at half that, because these are older. Note the raw split is misleading: quoted leads with no follow-up appear to convert at 97%, but that is because a follow-up only gets logged when the buyer did not say yes immediately. These 3 are the residue of that group, not part of its success.

- Work the never-followed-up list first, largest first: akhilkpfxx ($160, 181d), zain_qw ($75, 63d), Mohamed L ($60, 114d).
...
- Source rows: `akhilkpfxx: $160, 181d, 0 follow-ups`, `zain_qw: $75, 63d, 0 follow-ups`, `Mohamed L: $60, 114d, 0 follow-ups`, `bobzinos: $900, 168d, 1 follow-ups`, `farida_ism: $700, 201d, 1 follow-ups`, `ryan_wonders: $350, 127d, 1 follow-ups`, `rztwerk: $250, 37d, 1 follow-ups`, `chupetes: $200, 176d, 1 follow-ups`, `dgtl_depot: $175, 209d, 1 follow-ups`, `paulmesaric: $175, 208d, 1 follow-ups`

### P2 · Start recording upsells — the column is empty
**Owner:** All CSRs · **Est. impact:** $1,200 · **Effort:** 1.5h · **Confidence:** 50%

*Why:* Upsell is marked on 0.0% of the 216 orders whose tab has an Upsell column. That is not a low upsell rate, it is an unused column. The highest-value lever in the funnel currently cannot be measured, which means it cannot be improved or defended.
...
|---|---|---|---|
| 2026-09-09 | Organic orders over the 7 days to 09 Sep will be 8.2 (80% CI 4.5-11.8). | 4.51 – 11.83 | medium |
| 2026-09-16 | Organic health index in 14 days will be 28 (80% CI 18-39). | 18.15 – 38.50 | low |
| 2026-09-09 | Total orders/day averaged over the next 7 days will be 3.54 (80% CI 2.63-4.45). | 2.63 – 4.45 | medium |
| 2026-10-02 | Blended AOV in 30 days will be $100 (80% CI $85-$125). | 85.38 – 125.17 | high |
| 2026-09-09 | Inquiry->order conversion in 7 days will be 21.7% (80% CI 18.3%-26.2%). | 0.18 – 0.26 | high |

### Resolved since last run

| Made on | Prediction | Predicted | Actual | In interval? |
|---|---|---|---|---|
| 2026-08-19 | health.index | 61.10 | 19.70 | ❌ |
| 2026-08-26 | flow_7d.organic | 11.03 | 9.00 | ✅ |
| 2026-08-26 | flow_7d.total_per_day | 3.61 | 3.71 | ✅ |
| 2026-08-26 | funnel.conversion | 0.21 | 0.22 | ✅ |

**Track record:** 157 resolved, coverage 50% 
...
| Metric | Value | Note |
|---|---|---|
| Organic orders/day (7d MA) | 1.29 | vs 1.86 14d ago |
| Organic, recent vs earlier | 1.41/day | was 0.66/day (+115.1%) |
| Organic orders, 7d to 1 Sep | 9 | 1.29/day |
| AOV | $100 | median $80, n=188 priced orders |
| Lifetime tracked revenue | $18,802 | across 216 order rows |
| Inquiry conversion | 21.7% | 28/129 |
| Upsell recorded | 0.0% | column is effectively unused |
| Review capture | 67.1% | 145/216 orders that could be rated |
| Gig rating | 4.841 | 1,637 reviews, Level 2 |
| Orders in queue | 22 | live from the gig page |

### Revenue path

At 1.29 orders/day and $100 AOV, the next 30 days project **$3,858** (39 orders).
...
|---|---|---|---|
| Shift: Night | 38 | 28.9% | 17.0% |
| Shift: Evening | 41 | 24.4% | 13.8% |
| Shift: Morning | 46 | 13.0% | 6.1% |
...
| Order and inquiry workbooks | 🟢 live | 2026-09-02T02:15:07.242000+00:00 | 0h | Apps Script snapshot endpoint |
| Impressions source | 🟢 live | 2026-08-31 | 0h | impressions board, via IMPRESSIONS_SUPABASE_KEY |
| Impressions (engine copy) | 🟢 live | 2026-08-31 | 38h | board, merged over the Daily Data Sheet |
| Fiverr gig page | 🟠 stale | 2026-08-16 | 398h | browser capture into data/raw/gig/ |
| CSR handoff tracker | 🟠 stale | 2026-08-08 | 594h | uploaded into data/raw/order_tracker/ |
...
*Generated 2026-09-02 by the XStudioz growth engine. Read-only: no source sheet was modified.*