# XStudioz — What Next · Tuesday 18 August 2026

**Organic health: 🟢 HEALTHY** · index 60/100
...
| :-- | --: | :-- | --: | :-- |
| jordyspikker | 157d | revision | $100 | Ahmed Ashfaq |
| calumsnell | 155d | revision | $100 | Nime |
| elite9921 | 109d | in_progress | $105 | Musharaf |
| institutoibt | 82d | revision | $115 | Nimeazad |
| moni_rotanak | 82d | revision | $115 | Abiha Imran |
| institutoibt | 54d | revision | $120 | Nimeazad |
| hoppycampers | 43d | revision | $150 | Amin |
| goncalo_sa | 29d | revision | $115 | Amin |

**Quotes with no follow-up ever logged** — 3 worth $295

| Client | Quoted | Age | CSR |
| :-- | --: | --: | :-- |
| akhilkpfxx | $160 | 166d | Amrah |
| zain_qw | $75 | 48d | Swaid |
| Mohamed L | $60 | 99d | — |
...
*Why:* 5 orders worth $535 have been open longer than 60 days, out of 28 open orders worth $3,970 in total. The oldest is jordyspikker at 157 days. Every one of these buyers has already paid or committed, so this is not new business to win — it is delivered-or-owed work nobody closed. It is also the largest single block of recoverable money in the dataset, and unlike the funnel it needs no new traffic.
...
- Where we owe work — assign it to the designer named on the row with a delivery date this week. Oldest first: jordyspikker (157d, $100), calumsnell (155d, $100), elite9921 (109d, $105).
...
- Source rows: `jordyspikker: 157d, $100, revision`, `calumsnell: 155d, $100, revision`, `elite9921: 109d, $105, in_progress`, `institutoibt: 82d, $115, revision`, `moni_rotanak: 82d, $115, revision`

### P0 · Fill revenue in the daily ledger (188 days blank)
**Owner:** Whoever owns the daily ledger · **Est. impact:** $2,000 · **Effort:** 2.0h · **Confidence:** 90%

*Why:* 188 ledger days record orders but $0 revenue. Every revenue forecast, the AOV target and the whole revenue side of the objective are currently inferred from the CRM sheet instead of measured, because this column is empty.
...
*Why:* 3 buyers were quoted $295 between them and no follow-up was ever logged against any of them — the largest is akhilkpfxx at $160, quoted 166 days ago. That sits inside a total unanswered pipeline of $6,000 across 19 leads. Of the 27 quoted leads anyone did chase, 11 placed (41%); this is costed at half that, because these are older. Note the raw split is misleading: quoted leads with no follow-up appear to convert at 97%, but that is because a follow-up only gets logged when the buyer did not say yes immediately. These 3 are the residue of that group, not part of its success.

- Work the never-followed-up list first, largest first: akhilkpfxx ($160, 166d), zain_qw ($75, 48d), Mohamed L ($60, 99d).
...
- Source rows: `akhilkpfxx: $160, 166d, 0 follow-ups`, `zain_qw: $75, 48d, 0 follow-ups`, `Mohamed L: $60, 99d, 0 follow-ups`, `bobzinos: $900, 153d, 1 follow-ups`, `farida_ism: $700, 186d, 1 follow-ups`, `tatiana_1017: $510, 13d, 1 follow-ups`, `ryan_wonders: $350, 112d, 1 follow-ups`, `rztwerk: $250, 22d, 1 follow-ups`, `chupetes: $200, 161d, 1 follow-ups`, `dgtl_depot: $175, 194d, 1 follow-ups`

### P2 · Start recording upsells — the column is empty
**Owner:** All CSRs · **Est. impact:** $1,200 · **Effort:** 1.5h · **Confidence:** 50%

*Why:* Upsell is marked on 0.0% of the 159 orders whose tab has an Upsell column. That is not a low upsell rate, it is an unused column. The highest-value lever in the funnel currently cannot be measured, which means it cannot be improved or defended.
...
|---|---|---|---|
| 2026-08-25 | Organic orders over the 7 days to 25 Aug will be 14.6 (80% CI 9.7-19.5). | 9.75 – 19.54 | medium |
| 2026-09-01 | Organic health index in 14 days will be 60 (80% CI 30-77). | 29.58 – 77.11 | medium |
| 2026-08-25 | Total orders/day averaged over the next 7 days will be 4.85 (80% CI 3.79-5.92). | 3.79 – 5.92 | medium |
| 2026-09-17 | Blended AOV in 30 days will be $97 (80% CI $83-$120). | 82.52 – 119.73 | high |
| 2026-08-25 | Inquiry->order conversion in 7 days will be 22.7% (80% CI 18.0%-26.0%). | 0.18 – 0.26 | high |

### Resolved since last run

| Made on | Prediction | Predicted | Actual | In interval? |
|---|---|---|---|---|
| 2026-08-11 | flow_7d.organic | 24.14 | 11.00 | ❌ |
| 2026-08-11 | flow_7d.total_per_day | 7.38 | 4.00 | ❌ |
| 2026-08-11 | funnel.conversion | 0.22 | 0.23 | ✅ |

**Track record:** 97 resolved, coverage 46% 
...
| Metric | Value | Note |
|---|---|---|
| Organic orders/day (7d MA) | 1.57 | vs 0.71 14d ago |
| Organic, recent vs earlier | 1.33/day | was 0.66/day (+103.2%) |
| Organic orders, 7d to 17 Aug | 11 | 1.57/day |
| AOV | $97 | median $72, n=128 priced orders |
| Lifetime tracked revenue | $12,422 | across 159 order rows |
| Inquiry conversion | 22.7% | 22/97 |
| Upsell recorded | 0.0% | column is effectively unused |
| Review capture | 47.2% | 75/159 orders that could be rated |
| Gig rating | 4.841 | 1,637 reviews, Level 2 |
| Orders in queue | 22 | live from the gig page |

### Revenue path

At 1.57 orders/day and $97 AOV, the next 30 days project **$4,575** (47 orders).
...
| Shift: Evening | 35 | 22.9% | 12.1% |
| Shift: Morning | 31 | 12.9% | 5.1% |
| United Kingdom | 33 | 36.4% | 22.2% |
| United States | 25 | 24.0% | 11.5% |
...
| Order and inquiry workbooks | 🟢 live | 2026-08-18T02:14:25.258000+00:00 | 0h | Apps Script snapshot endpoint |
| Impressions source | 🔴 unreachable | — | — | impressions board, via IMPRESSIONS_SUPABASE_KEY |
| Impressions (engine copy) | 🟠 stale | 2026-08-06 | 278h | board, merged over the Daily Data Sheet |
| Fiverr gig page | 🟢 live | 2026-08-16 | 38h | browser capture into data/raw/gig/ |
| CSR handoff tracker | 🟢 live | 2026-08-08 | 234h | uploaded into data/raw/order_tracker/ |
...
*Generated 2026-08-18 by the XStudioz growth engine. Read-only: no source sheet was modified.*