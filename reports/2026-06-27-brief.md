# XStudioz — What Next · Saturday 27 June 2026

**Organic health: 🟢 HEALTHY** · index 65/100 · VVRO share 0% (cap 45%)

> Place **0 VVRO orders today** — quota is **4/week**, and today is a rest day (revenue_gap).
...
### P3 · Revive stalled order #7 — institutoibt (26d silent)
**Owner:** Assigned CSR · **Est. impact:** $51 · **Effort:** 0.25h · **Confidence:** 45%

*Why:* Status 'Rev Sent' with no update for 26 days. In this dataset, orders that go quiet after a revision are the ones that end up Dead — and a Dead order still occupies a delivery slot and produces no review.
...
### P3 · Revive stalled order #8 — adriamartin (28d silent)
**Owner:** Assigned CSR · **Est. impact:** $51 · **Effort:** 0.25h · **Confidence:** 45%

*Why:* Status 'Rev Sent' with no update for 28 days. In this dataset, orders that go quiet after a revision are the ones that end up Dead — and a Dead order still occupies a delivery slot and produces no review.
...
- **Quota:** 4/week (0.57/day) · today: **0**
- **Ceiling from share cap:** 0.58/day at the current organic rate of 0.71/day
- **Projected VVRO share at this rate:** 44%
- **Cooldown until:** 2026-06-26

| Date | Day | Place | Price bands |
|---|---|---|---|
| 2026-06-27 | Sat | 0 | — |
| 2026-06-28 | Sun | 1 | 1x $86-$150 |
| 2026-06-29 | Mon | 0 | — |
| 2026-06-30 | Tue | 1 | 1x $86-$150 |
| 2026-07-01 | Wed | 1 | 1x $151-$260 |
| 2026-07-02 | Thu | 0 | — |
| 2026-07-03 | Fri | 1 | 1x $45-$85 |

Per ISO week: **2026-W26** = 1, **2026-W27** = 3 (quota is 4/week; a 7-day window straddles two weeks, so these will not both equal the quota).
...
|---|---|---|---|
| 2026-07-04 | Organic orders over the 7 days to 04 Jul will be 5.6 (80% CI 2.6-8.6). | 2.57 – 8.63 | medium |
| 2026-07-11 | Organic health index in 14 days will be 65 (80% CI 56-88). | 56.13 – 87.79 | medium |
| 2026-07-04 | Total orders/day averaged over the next 7 days will be 3.21 (80% CI 2.34-4.07). | 2.34 – 4.07 | medium |
| 2026-07-27 | Blended AOV in 30 days will be $128 (80% CI $113-$144). | 112.98 – 143.80 | high |
| 2026-07-04 | Inquiry->order conversion in 7 days will be 33.5% (80% CI 29.2%-37.7%). | 0.29 – 0.38 | high |

### Resolved since last run

| Made on | Prediction | Predicted | Actual | In interval? |
|---|---|---|---|---|
| 2026-06-11 | health.index | 63.30 | 65.00 | ✅ |
| 2026-06-19 | flow_7d.organic | 5.60 | 5.00 | ✅ |
| 2026-06-19 | flow_7d.total_per_day | 3.21 | 0.71 | ❌ |
| 2026-06-19 | funnel.conversion | 0.33 | 0.33 | ✅ |

**Track record:** 18 resolved, coverage 56% 
...
| Metric | Value | Note |
|---|---|---|
| Organic orders/day (7d MA) | 0.71 | vs 0.67 14d ago |
...
At 1.29 orders/day and $128 AOV, the next 30 days project **$4,952** (39 orders).

That is **$3,548 behind** the 30-day target. Two routes close it:

- **Volume:** +28 orders (+0.92/day). **Not feasible** — the organic constraint caps volume, and VVRO is already at its ceiling.
- **AOV:** raise AOV to $220 (+72%). This is the route the constraint leaves open.
...
*Generated 2026-06-27 by the XStudioz growth engine. Read-only: no source sheet was modified.*