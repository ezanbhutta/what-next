# XStudioz — What Next · Tuesday 23 June 2026

**Organic health: 🔴 BREACH** · index 34/100 · VVRO share 0% (cap 45%)

> Place **0 VVRO orders today** — quota is **0/week**, and today is a rest day (organic_health_breach).

**Why the constraint is breached**
- rolling: 7d MA -57.1% vs 14d ago (1.00 -> 0.43/day)
...
*Why:* Organic constraint breached — rolling: 7d MA -57.1% vs 14d ago (1.00 -> 0.43/day). The objective makes organic recovery a hard constraint, so the dose is cut by 2/day and revenue upside is ignored until flow recovers. Quota 0/week (0.00/day); share cap allows 0.35/day.

- Place **0 VVRO orders today** — quota is **0/week**, and today is a rest day (organic_health_breach).
- No placements today.
- At this quota the VVRO share settles at 0%, against a cap of 0.35 VVRO/day at the current organic rate.
...
### P3 · Revive stalled order #7 — institutoibt (22d silent)
**Owner:** Assigned CSR · **Est. impact:** $51 · **Effort:** 0.25h · **Confidence:** 45%

*Why:* Status 'Rev Sent' with no update for 22 days. In this dataset, orders that go quiet after a revision are the ones that end up Dead — and a Dead order still occupies a delivery slot and produces no review.
...
- **Ceiling from share cap:** 0.35/day at the current organic rate of 0.43/day
...
Per ISO week: **2026-W26** = 0, **2026-W27** = 0 (quota is 0/week; a 7-day window straddles two weeks, so these will not both equal the quota).
...
|---|---|---|---|
| 2026-06-30 | Organic orders over the 7 days to 30 Jun will be 5.6 (80% CI 2.6-8.6). | 2.57 – 8.63 | medium |
| 2026-07-07 | Organic health index in 14 days will be 46 (80% CI 41-65). | 41.43 – 64.80 | low |
| 2026-06-30 | Total orders/day averaged over the next 7 days will be 3.21 (80% CI 2.34-4.07). | 2.34 – 4.07 | medium |
| 2026-07-23 | Blended AOV in 30 days will be $128 (80% CI $113-$144). | 112.98 – 143.80 | high |
| 2026-06-30 | Inquiry->order conversion in 7 days will be 33.5% (80% CI 28.4%-38.5%). | 0.28 – 0.38 | high |

### Resolved since last run

| Made on | Prediction | Predicted | Actual | In interval? |
|---|---|---|---|---|
| 2026-06-07 | health.index | 51.10 | 33.50 | ❌ |
| 2026-06-15 | flow_7d.organic | 5.60 | 3.00 | ✅ |
| 2026-06-15 | flow_7d.total_per_day | 3.21 | 0.43 | ❌ |
| 2026-06-15 | funnel.conversion | 0.33 | 0.33 | ✅ |

**Track record:** 14 resolved, coverage 50% 
(target 80%), median absolute error 33%.
...
| Metric | Value | Note |
|---|---|---|
| Organic orders/day (7d MA) | 0.43 | vs 1.00 14d ago |
| Total orders/day (7d) | 0.43 | 3 organic + 0 VVRO |
...
At 0.43 orders/day and $128 AOV, the next 30 days project **$1,651** (13 orders).

That is **$6,849 behind** the 30-day target. Two routes close it:

- **Volume:** +53 orders (+1.78/day). **Not feasible** — the organic constraint caps volume, and VVRO is already at its ceiling.
- **AOV:** raise AOV to $660 (+414%). This is the route the constraint leaves open.
...
*Generated 2026-06-23 by the XStudioz growth engine. Read-only: no source sheet was modified.*