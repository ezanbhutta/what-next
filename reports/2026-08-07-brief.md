# XStudioz — What Next · Friday 07 August 2026
...
| paolowhite | 104d | delivered | $320 | Zahid |
...
| :-- | --: | --: | :-- |
| akhilkpfxx | $160 | 155d | — |
| architpatel497 | $147 | 43d | Iqra |
| kai_utzinger | $85 | 102d | — |
| zain_qw | $75 | 37d | Swaid |
| Mohamed L | $60 | 88d | — |
...
*Why:* Buyer has raised refund/dispute language and the order is rev sent. A single 1-star review would move the public rating by 0.0024 (4.839 -> 4.837) across 1,606 reviews, and that rating is what every future buyer sorts on. The order is worth ~$90; the rating damage is worth far more.
...
- Source rows: `osmanbey_35: 274d, $250, in_progress`, `faisalkazmi53: 190d, $0, in_progress`, `andrem530: 165d, $295, revision`, `jordyspikker: 146d, $100, revision`, `calumsnell: 144d, $100, revision`, `kuykendalljr: 141d, $75, in_progress`, `vickizhou318: 132d, $0, in_progress`, `paolowhite: 104d, $320, delivered`, `alialbalawi896: 99d, $115, revision`, `elite9921: 98d, $105, in_progress`
...
*Why:* Dulal Khan averages $129 across 8 orders; Abiha averages $78 across 7. Some of that is brief mix rather than skill — but routing the $200+ briefs to the designers who already deliver at that level protects both AOV and rating.
...
**Owner:** Delivery lead · **Est. impact:** $81 · **Effort:** 1.0h · **Confidence:** 80%
...
*Why:* 5 buyers were quoted $527 between them and no follow-up was ever logged against any of them — the largest is akhilkpfxx at $160, quoted 155 days ago. That sits inside a total unanswered pipeline of $6,232 across 21 leads. Of the 25 quoted leads anyone did chase, 9 placed (36%); this is costed at half that, because these are older. Note the raw split is misleading: quoted leads with no follow-up appear to convert at 93%, but that is because a follow-up only gets logged when the buyer did not say yes immediately. These 5 are the residue of that group, not part of its success.

- Work the never-followed-up list first, largest first: akhilkpfxx ($160, 155d), architpatel497 ($147, 43d), kai_utzinger ($85, 102d), zain_qw ($75, 37d).
...
- Source rows: `akhilkpfxx: $160, 155d, 0 follow-ups`, `architpatel497: $147, 43d, 0 follow-ups`, `kai_utzinger: $85, 102d, 0 follow-ups`, `zain_qw: $75, 37d, 0 follow-ups`, `Mohamed L: $60, 88d, 0 follow-ups`, `bobzinos: $900, 142d, 1 follow-ups`, `farida_ism: $700, 175d, 1 follow-ups`, `tatiana_1017: $510, 2d, 1 follow-ups`, `ryan_wonders: $350, 101d, 1 follow-ups`, `rztwerk: $250, 11d, 1 follow-ups`
...
| 2026-09-06 | Blended AOV in 30 days will be $90 (80% CI $79-$104). | 79.04 – 104.21 | high |
| 2026-08-14 | Inquiry->order conversion in 7 days will be 19.1% (80% CI 16.4%-22.1%). | 0.16 – 0.22 | high |
...
At 1.43 orders/day and $90 AOV, the next 30 days project **$3,867** (43 orders).
...
*Generated 2026-08-07 by the XStudioz growth engine. Read-only: no source sheet was modified.*