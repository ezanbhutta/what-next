# XStudioz — What Next · Tuesday 25 August 2026

**Organic health: 🔴 BREACH** · index 26/100

**Why the constraint is breached**
- rolling: 7d MA -45.8% vs 14d ago (3.43 -> 1.86/day)
...
| :-- | --: | :-- | --: | :-- |
| jordyspikker | 164d | revision | $100 | Ahmed Ashfaq |
| calumsnell | 162d | revision | $100 | Nime |
| elite9921 | 116d | in_progress | $105 | Musharaf |
| institutoibt | 89d | revision | $115 | Nimeazad |
| moni_rotanak | 89d | revision | $115 | Abiha Imran |
| institutoibt | 61d | revision | $120 | Nimeazad |
| hoppycampers | 50d | revision | $150 | Amin |
| thisguy07 | 25d | revision | $250 | Amin |

**Quotes with no follow-up ever logged** — 4 worth $675

| Client | Quoted | Age | CSR |
| :-- | --: | --: | :-- |
| kutaibahussain | $380 | 5d | Hasnain |
| akhilkpfxx | $160 | 173d | Amrah |
| zain_qw | $75 | 55d | Swaid |
| Mohamed L | $60 | 106d | — |
...
*Why:* 6 orders worth $655 have been open longer than 60 days, out of 23 open orders worth $3,565 in total. The oldest is jordyspikker at 164 days. Every one of these buyers has already paid or committed, so this is not new business to win — it is delivered-or-owed work nobody closed. It is also the largest single block of recoverable money in the dataset, and unlike the funnel it needs no new traffic.
...
- Where we owe work — assign it to the designer named on the row with a delivery date this week. Oldest first: jordyspikker (164d, $100), calumsnell (162d, $100), elite9921 (116d, $105).
...
- Source rows: `jordyspikker: 164d, $100, revision`, `calumsnell: 162d, $100, revision`, `elite9921: 116d, $105, in_progress`, `institutoibt: 89d, $115, revision`, `moni_rotanak: 89d, $115, revision`, `institutoibt: 61d, $120, revision`

### P0 · Organic decline is a gig page and handling problem — act accordingly
**Owner:** CEO · **Est. impact:** $16,245 · **Effort:** 2.0h · **Confidence:** 75%

*Why:* Orders moved -97.1% over 14 days (170 -> 5). 88% of that swing is closing rate, which fell: impressions 117,898 -> 84,078, CTR 1.60% -> 1.79%, close rate 9.0% -> 0.3%. That makes this a gig page and handling problem — work on gig copy, packages, response speed, CSR quality.
...
### P0 · Fill revenue in the daily ledger (213 days blank)
**Owner:** Whoever owns the daily ledger · **Est. impact:** $2,000 · **Effort:** 2.0h · **Confidence:** 90%

*Why:* 213 ledger days record orders but $0 revenue. Every revenue forecast, the AOV target and the whole revenue side of the objective are currently inferred from the CRM sheet instead of measured, because this column is empty.
...
*Why:* 4 buyers were quoted $675 between them and no follow-up was ever logged against any of them — the largest is kutaibahussain at $380, quoted 5 days ago. That sits inside a total unanswered pipeline of $6,680 across 21 leads. Of the 31 quoted leads anyone did chase, 14 placed (45%); this is costed at half that, because these are older. Note the raw split is misleading: quoted leads with no follow-up appear to convert at 96%, but that is because a follow-up only gets logged when the buyer did not say yes immediately. These 4 are the residue of that group, not part of its success.

- Work the never-followed-up list first, largest first: kutaibahussain ($380, 5d), akhilkpfxx ($160, 173d), zain_qw ($75, 55d), Mohamed L ($60, 106d).
...
- Source rows: `kutaibahussain: $380, 5d, 0 follow-ups`, `akhilkpfxx: $160, 173d, 0 follow-ups`, `zain_qw: $75, 55d, 0 follow-ups`, `Mohamed L: $60, 106d, 0 follow-ups`, `bobzinos: $900, 160d, 1 follow-ups`, `farida_ism: $700, 193d, 1 follow-ups`, `tatiana_1017: $510, 20d, 1 follow-ups`, `ryan_wonders: $350, 119d, 1 follow-ups`, `rztwerk: $250, 29d, 1 follow-ups`, `chupetes: $200, 168d, 1 follow-ups`
...
*Why:* Upsell is marked on 0.0% of the 188 orders whose tab has an Upsell column. That is not a low upsell rate, it is an unused column. The highest-value lever in the funnel currently cannot be measured, which means it cannot be improved or defended.
...
|---|---|---|---|
| 2026-09-01 | Organic orders over the 7 days to 01 Sep will be 10.6 (80% CI 6.4-14.8). | 6.43 – 14.77 | medium |
| 2026-09-08 | Organic health index in 14 days will be 34 (80% CI 21-42). | 21.21 – 41.92 | low |
| 2026-09-01 | Total orders/day averaged over the next 7 days will be 3.76 (80% CI 2.82-4.69). | 2.82 – 4.69 | medium |
| 2026-09-24 | Blended AOV in 30 days will be $98 (80% CI $83-$125). | 82.50 – 124.79 | high |
| 2026-09-01 | Inquiry->order conversion in 7 days will be 21.9% (80% CI 17.9%-25.1%). | 0.18 – 0.25 | high |

### Resolved since last run

| Made on | Prediction | Predicted | Actual | In interval? |
|---|---|---|---|---|
| 2026-08-11 | health.index | 82.40 | 25.90 | ❌ |
| 2026-08-18 | flow_7d.organic | 14.65 | 13.00 | ✅ |
| 2026-08-18 | flow_7d.total_per_day | 4.85 | 4.14 | ✅ |
| 2026-08-18 | funnel.conversion | 0.23 | 0.22 | ✅ |

**Track record:** 124 resolved, coverage 49% 
...
| Metric | Value | Note |
|---|---|---|
| Organic orders/day (7d MA) | 1.86 | vs 3.43 14d ago |
| Organic, recent vs earlier | 1.42/day | was 0.66/day (+116.2%) |
| Organic orders, 7d to 24 Aug | 13 | 1.86/day |
| AOV | $98 | median $80, n=157 priced orders |
| Lifetime tracked revenue | $15,457 | across 188 order rows |
| Inquiry conversion | 21.9% | 25/114 |
| Upsell recorded | 0.0% | column is effectively unused |
| Review capture | 47.3% | 89/188 orders that could be rated |
| Gig rating | 4.841 | 1,637 reviews, Level 2 |
| Orders in queue | 22 | live from the gig page |

### Revenue path

At 1.86 orders/day and $98 AOV, the next 30 days project **$5,485** (56 orders).
...
| Shift: Evening | 39 | 23.1% | 12.6% |
| Shift: Morning | 37 | 13.5% | 5.9% |
| United Kingdom | 35 | 37.1% | 23.2% |
| United States | 30 | 23.3% | 11.8% |
...
| Order and inquiry workbooks | 🟢 live | 2026-08-25T02:14:37.480000+00:00 | 0h | Apps Script snapshot endpoint |
| Impressions source | 🟢 live | 2026-08-23 | 0h | impressions board, via IMPRESSIONS_SUPABASE_KEY |
| Impressions (engine copy) | 🟢 live | 2026-08-23 | 38h | board, merged over the Daily Data Sheet |
| Fiverr gig page | 🟠 stale | 2026-08-16 | 206h | browser capture into data/raw/gig/ |
| CSR handoff tracker | 🟠 stale | 2026-08-08 | 402h | uploaded into data/raw/order_tracker/ |
...
*Generated 2026-08-25 by the XStudioz growth engine. Read-only: no source sheet was modified.*