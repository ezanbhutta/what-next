# XStudioz — What Next · Saturday 01 August 2026
...
| :-- | --: | :-- | --: | :-- |
| osmanbey_35 | 268d | in_progress | $250 | Aashir |
| johnjk001 | 212d | delivered | $0 | Dulal Khan |
| faisalkazmi53 | 184d | in_progress | $0 | Shaoor |
| madewelltech | 174d | delivered | $120 | Amin |
| andrem530 | 159d | revision | $295 | Amin |
| jordyspikker | 140d | revision | $100 | Ahmed Ashfaq |
| calumsnell | 138d | revision | $100 | Nime |
| kuykendalljr | 135d | in_progress | $75 | Saad Sajid |
...
| :-- | --: | --: | :-- |
| akhilkpfxx | $160 | 149d | — |
| architpatel497 | $147 | 37d | Iqra |
| kai_utzinger | $85 | 96d | — |
| zain_qw | $75 | 31d | Swaid |
| Mohamed L | $60 | 82d | — |
...
- Where we owe work — assign it to the designer named on the row with a delivery date this week. Oldest first: osmanbey_35 (268d, $250), madewelltech (174d, $120), andrem530 (159d, $295).
...
- Source rows: `osmanbey_35: 268d, $250, in_progress`, `johnjk001: 212d, $0, delivered`, `faisalkazmi53: 184d, $0, in_progress`, `madewelltech: 174d, $120, delivered`, `andrem530: 159d, $295, revision`, `jordyspikker: 140d, $100, revision`, `calumsnell: 138d, $100, revision`, `kuykendalljr: 135d, $75, in_progress`, `vickizhou318: 126d, $0, in_progress`, `paolowhite: 98d, $320, delivered`
...
*Why:* 5 buyers were quoted $527 between them and no follow-up was ever logged against any of them — the largest is akhilkpfxx at $160, quoted 149 days ago. That sits inside a total unanswered pipeline of $5,722 across 20 leads. Of the 24 quoted leads anyone did chase, 9 placed (38%); this is costed at half that, because these are older. Note the raw split is misleading: quoted leads with no follow-up appear to convert at 92%, but that is because a follow-up only gets logged when the buyer did not say yes immediately. These 5 are the residue of that group, not part of its success.

- Work the never-followed-up list first, largest first: akhilkpfxx ($160, 149d), architpatel497 ($147, 37d), kai_utzinger ($85, 96d), zain_qw ($75, 31d).
...
- Source rows: `akhilkpfxx: $160, 149d, 0 follow-ups`, `architpatel497: $147, 37d, 0 follow-ups`, `kai_utzinger: $85, 96d, 0 follow-ups`, `zain_qw: $75, 31d, 0 follow-ups`, `Mohamed L: $60, 82d, 0 follow-ups`, `bobzinos: $900, 136d, 1 follow-ups`, `farida_ism: $700, 169d, 1 follow-ups`, `ryan_wonders: $350, 95d, 1 follow-ups`, `rztwerk: $250, 5d, 1 follow-ups`, `chupetes: $200, 144d, 1 follow-ups`
...
|---|---|---|---|
| 2026-08-08 | Organic orders over the 7 days to 08 Aug will be 6.7 (80% CI 3.4-10.0). | 3.40 – 10.04 | medium |
| 2026-08-15 | Organic health index in 14 days will be 46 (80% CI 27-66). | 26.98 – 65.73 | medium |
| 2026-08-08 | Total orders/day averaged over the next 7 days will be 3.60 (80% CI 2.68-4.52). | 2.68 – 4.52 | medium |
| 2026-08-31 | Blended AOV in 30 days will be $110 (80% CI $98-$124). | 98.30 – 124.35 | high |
| 2026-08-08 | Inquiry->order conversion in 7 days will be 11.8% (80% CI 10.4%-13.7%). | 0.10 – 0.14 | high |

**Track record:** 62 resolved, coverage 60% 
...
| Organic orders, last 7d | 6 | 0.86/day |
...
*Generated 2026-08-01 by the XStudioz growth engine. Read-only: no source sheet was modified.*